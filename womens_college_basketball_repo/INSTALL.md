# Installation Guide - Women's College Basketball Betting System

## Quick Install

```bash
# Clone the repository
git clone https://github.com/yourusername/womens-college-basketball-betting.git
cd womens-college-basketball-betting
...
```bash
WCBB_BANKROLL=50000.0          # Your total bankroll
WCBB_UNIT_SIZE=500.0           # Base unit size
WCBB_MAX_EXPOSURE=0.10         # Max 10% exposure per game
WCBB_MIN_EDGE_THRESHOLD=0.05   # Minimum 5% edge required
```
...
- Solution: WCBB season runs from November to March. Check if games are currently scheduled.
...
2. Review wcbb_config.py for customization options

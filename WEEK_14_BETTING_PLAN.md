# 📊 WEEK 14 BETTING PLAN - NCAA Football
...
**Phase**: CCG week - select strong teams

**Expected Metrics**:
- Home Win Rate: 55%
- Average Margin: 2.5+ points
- Edge Type: MODERATE
- Bet Size Guidance: See tier system below

---

## 💰 Tier System for Week 14

### Expected Tier Distribution

Based on week 14 patterns, expect:
...
- **TIER 1**: 2.5% bankroll (if MEGA edge exists) - RARE for week 14
- **TIER 2**: 2.0% bankroll (if SUPER edge exists) - RARE for week 14
...
- TIER 1: 88% (unlikely week 14)
- TIER 2: 81% (unlikely week 14)
- TIER 3: 73% (realistic target)
- TIER 4: 65% (more common week 14)
...
Week 14 conference home field advantages:

**Big Ten** (82% home)
- Multiplier: 1.25×
- Note: Strongest conference

**Mountain West** (81% home)
- Multiplier: 1.22×
- Note: Consistent edge
...
**ACC** (63% home)
- Multiplier: 1.10×
- Note: Weak home field

**Pac-12** (54% home)
- Multiplier: 0.92×
- Note: Poor home field - AVOID
...
**Key Dynamics**:
1. CCG matchups set (usually auto-bid conferences)
2. Final regular season for Group of Five
3. Seeding implications critical
4. Teams with nothing to play for may underperform
...
## 📋 What to Look For When Betting Week 14
...
- Non-conference mismatch (if any exist week 14)
...
- Team bowl eligibility status (coming into week 14)
...
Expected combined win rate: 62-65% (good for week 14)
...
**Recommended Risk**: 6-12% of bankroll (lower risk week 14)

**Expected Win Rate**: 55% baseline → 62-65% with edge selection
...
## ✅ Pre-Week Checklist (Do This BEFORE Week 14 Games Start)

- [ ] Run prediction model on all week 14 matchups

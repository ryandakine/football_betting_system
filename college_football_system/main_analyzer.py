#!/usr/bin/env python3
"""
Unified College Football Analyzer - Main System
===============================================
...
from college_football_system.social_weather_analyzer import CombinedSocialWeatherAnalyzer
from college_football_system.parlay_optimizer import ParlayOptimizer
from college_football_system.realtime_monitor import RealTimeMonitor

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)


class UnifiedCollegeFootballAnalyzer:
    """
    Master analyzer combining all college football betting features.
    """
    ...
    def __init__(self, bankroll: float = 50000.0):
        ...
        logger.info("🏈 Unified College Football Analyzer initialized")
    
    async def run_complete_analysis(self) -> Dict[str, Any]:
        """Run complete analysis pipeline."""
        print("\n🏈 UNIFIED COLLEGE FOOTBALL ANALYSIS")
        print("=" * 70)
    ...
    async def analyze_single_game(self, game: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 5. College 5-AI council consensus with full context
    ...
    def _apply_meta_learning(
        ...
        try:
            self.meta_learner.log_prediction(
                ...
                meta_probability=meta_probability,
                source='college_unified_analyzer',
            )
        except Exception as exc:
...
class ConferenceExpertAgent:
    async def analyze(self, context: CouncilInput) -> Dict[str, Any]:
        ...
        power_conferences = {'SEC', 'BIG TEN', 'BIG 10', 'BIG XII', 'BIG 12', 'ACC', 'PAC-12', 'PAC 12'}

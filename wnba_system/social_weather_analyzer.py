#!/usr/bin/env python3
"""
WNBA Social & Weather Analysis
==============================

Combines social sentiment and weather impact analysis for WNBA.
"""
...
class CombinedSocialWeatherAnalyzer:
    """
    Lightweight analyzer combining social sentiment for WNBA betting edges.
    Weather has minimal impact (indoor sport).
    """

    def __init__(self):
        self.enabled = True
        logger.info("🌤️ WNBA Social & Weather Analyzer initialized")

    async def analyze_game_context(self, game: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
        Analyze social sentiment for a WNBA game.

        Returns:
            Combined social/weather context with edge adjustments.
        """
        try:
            # Social sentiment analysis (WNBA has strong fan engagement)
            ...
            edge_adjustment = sentiment_gap * 0.025  # WNBA social sentiment matters
    ...
    def _analyze_team_sentiment(self, team: Optional[str], is_home: bool) -> Dict[str, Any]:
        ...
        # WNBA has strong social media presence
        base_score = 0.52 if is_home else 0.48

#!/usr/bin/env python3
"""
Quick start script for WNBA Betting System
"""
...
from main_analyzer import UnifiedWNBAAnalyzer


async def main():
    """Run the complete analysis."""
    print("🏀 WNBA Betting System")
    print("=" * 60)
    ...
    # Initialize analyzer
    analyzer = UnifiedWNBAAnalyzer(bankroll=bankroll)

# 📊 WEEK 12 BETTING PLAN - NCAA Football
...
**Phase**: Bowl eligibility race

**Expected Metrics**:
- Home Win Rate: 52%
- Average Margin: 1.5+ points
- Edge Type: SELECTIVE
- Bet Size Guidance: See tier system below

---

## 💰 Tier System for Week 12

### Expected Tier Distribution

Based on week 12 patterns, expect:
...
- **TIER 1**: 2.5% bankroll (if MEGA edge exists) - RARE for week 12
- **TIER 2**: 2.0% bankroll (if SUPER edge exists) - RARE for week 12
...
- TIER 1: 88% (unlikely week 12)
- TIER 2: 81% (unlikely week 12)
- TIER 3: 73% (realistic target)
- TIER 4: 65% (more common week 12)
...
Week 12 conference home field advantages:
...
**Key Dynamics**:
1. Teams fighting for 6-win bowl eligibility
2. Motivation levels highly variable
3. Underdog value in desperation games
4. Big teams protecting seeding
...
## 📋 What to Look For When Betting Week 12
...
- Non-conference mismatch (if any exist week 12)
...
- Team bowl eligibility status (coming into week 12)
...
Expected combined win rate: 62-65% (good for week 12)
...
**Recommended Risk**: 6-12% of bankroll (lower risk week 12)

**Expected Win Rate**: 52% baseline → 62-65% with edge selection
...
## ✅ Pre-Week Checklist (Do This BEFORE Week 12 Games Start)

- [ ] Run prediction model on all week 12 matchups

# NFL Kelly Betting System - Agents & Workflow

## 🎯 System Overview
This document describes the agents (components) and workflow of the NFL Kelly Betting System. Each agent has a specific role in the betting pipeline.

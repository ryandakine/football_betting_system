...
class UnifiedNFLIntelligenceSystem:
    ...
    async def run_unified_analysis(self, game_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            total_edge = self._calculate_total_edge(results)
    ...
    async def _generate_unified_recommendation(self, legacy: Dict, realtime: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            combined_confidence = (legacy_confidence * 0.6 + realtime_confidence * 0.4)  # Legacy weighted higher for deep analysis
    ...
    def _calculate_total_edge(self, results: Dict[str, Any]) -> float:
